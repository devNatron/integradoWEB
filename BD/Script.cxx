...
int main()
{
	...
	primeira = "INSERT INTO instituicao VALUES (";
	segunda = ");\n";
	...
	for(int i = 0; i < 100000; i++){
		primeira = "INSERT INTO campus VALUES (";
		...
		if(i < 10000)
			...
			aux1 = "'UN" + to_string(aleatorio(1,10000)) + "'";
			
		insti = primeira + aux2 + aux4 + aux3 + aux1 + segunda;
		f_out << insti;
	

	primeira = "INSERT INTO curso VALUES (";
		...
		aux7 = ", 'Campus Universitário " + to_string(i+1) + "', ";
	
		insti = primeira + aux2 + aux8 + aux9 + aux3 + aux4 + aux5 + aux6 + aux7 + aux1 + segunda;
		f_out << insti;
	}
